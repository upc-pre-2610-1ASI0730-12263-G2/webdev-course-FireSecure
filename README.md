...
**📂 Repositorio de código fuente**: [Repositorio de GitHub](https://github.com/upc-pre-2610-1ASI0730-12263-G2/webdev-course-FireSecure)
...
- **Consejos clave**:
  ...
  - El DOM es la representación del navegador de tu página
  - Una página web es un documento, un sitio web es un conjunto de páginas
...
- **Consejos clave**:
  ...
  - `src` y `alt` son obligatorios en imágenes
...
- **Código Fuente Completo**: [Repositorio de GitHub](https://github.com/upc-pre-2610-1ASI0730-12263-G2/webdev-course-FireSecure)
...
**Nombre del equipo**: FireSecure 
**Líder del equipo**: Cesar Jair Contreras Rojas 
**Integrantes del equipo**:
####  - Briguite Eryka Carhuaz Centeno
####  - Gabriel Ferran Espinar Martínez
####  - Camila Alizée Otiniano Rosales
####  - Valeria Alexandra Rojas Gomez
